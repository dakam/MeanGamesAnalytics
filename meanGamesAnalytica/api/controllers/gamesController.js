...
module.exports.GamesGetAll= function(req, res) {
    ...
    if(req.query && req.query.analytics) {

        Game.find().exec(function(err, fetchedgamesanalytics) {
            console.log("Found Games Analytics");
            res.status(200).json(fetchedgamesanalytics);
        });  
